...
-   We can think of the overall reconviction rate as a *weighted* mean of the reconviction rates in different demographic groups, weighted by the group size. You can have changes in the overall rate due to changes in the *weights* or changes in the rates.
...
-   To use reconviction rates as measures of criminal justice system 'performance' for anything post-conviction you only want to measure change in the subgroup rates
...
-   Some evidence that Scotland might be an extreme case here with larger demographic changes in criminal convictions than in other countries [@matthews2023]
...
## Trends in reconviciton rate by age group
...
## Standardized reconviction rates
...
-   Young people used to have the highest reconviction rate of all age groups, but these rates have fallen
-   Those over 40 have consistently lower reconviction rates, but these rates have not fallen
...
-   Having ten performance measures rather than one performance measure goes against logic of quantification - the whole point is to reduce the amount of information required to understand the thing you care about and have an 'objective' and apolitical measure [@porter1996]
...
-   This is the paradoxical bit of Simpson's paradox; it is paradoxical because you need to choose what story to tell about the data, not because of anything inherently statistical [@pearl2014]
