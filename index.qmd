...
-   We use an implementation of standardization and decomposition [@dasguptaStandardizationDecompositionRates1993] and implemented in the `{dasguptr}` R package [@king2025]
